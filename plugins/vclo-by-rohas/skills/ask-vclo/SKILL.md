...
2. Select the relevant practice-area specialist. When local law is material, also select the relevant jurisdiction counsel: `vclo-by-rohas:india-counsel`, `vclo-by-rohas:us-counsel` or `vclo-by-rohas:uk-counsel`. Invoke it before applying local rules.
...
4. For a genuinely multi-step matter, read the relevant workflow:
   ...
   - [Commercial dispute lifecycle](../../workflows/commercial-dispute-lifecycle.md)
   - [Arbitration lifecycle](../../workflows/arbitration-lifecycle.md)
...
- When external legal authority materially affects the answer, follow the CLO's shared legal-research protocol and the applicable India, US or UK Counsel module. Verify the law applicable on the relevant date, not only current text. Never invent or overstate an authority, search, connection or verification.
